...
#remove scaffolds
cpg.sub=subset(cpg,cpg$V1!='chloroplast' & cpg$V1!='mitochondria')
chg.sub=subset(chg,chg$V1!='chloroplast' & chg$V1!='mitochondria')
chh.sub=subset(chh,chh$V1!='chloroplast' & chh$V1!='mitochondria')
